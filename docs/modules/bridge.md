...
- Core 1.3.0 schema 8 adds three bounded read-only research/runtime-context
  ...
  ownership through `CvTeamTechs`, UI agreement, positive whole-point overflow,
  selection preservation, later application, and one-session continuity across
  both interturns after ADR-0043.
...
executor integration, and complete offline gate. C6 confirms read/UI
agreement, stale-source rejection, and one verified
