...
unit-class, promotion, policy, and policy-branch gameplay fields plus their
prerequisite, era, technology, upgrade, default-unit, free-promotion, and policy
tree relations. It uses
