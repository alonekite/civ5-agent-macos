...
- [Runtime research facts plan](planning/RESEARCH_RUNTIME_FACTS_PLAN.md): accepted
...
- [Research runtime facts contract](contracts/research-runtime-facts.md): frozen M11
