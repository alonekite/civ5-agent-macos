...
| M6 deterministic turn executor | ADR-0015/0016/0017/0018/0022 and TurnPlan schema 1 | Strict admission/report states, factual requirements, four-action ordered completion, uncovered-requirement pause, post-action drift, invalid plan, bridge rejection/error, and unknown-outcome/no-retry tests | No | Ordered in-process core implemented offline; event sink, watcher adapter, and explicit recovery pending; independent of knowledge/M5 |
