...
| M6 deterministic turn executor | ADR-0015/0016/0017/0018 and proposed TurnPlan contract | No implementation yet | No | Planned; depends only on bridge contracts, operates without knowledge/M5, and may emit optional recordable events |
