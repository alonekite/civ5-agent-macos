...
| Ruleset resolver | Context selection uses the real validated knowledge model; effective modifier integration pending | Exact-ruleset match, canonical selection, unknown/duplicate rejection, provenance, and base-isolation tests | N/A | Initial contract implemented offline |
