...
| M6 deterministic turn executor | ADR-0015/0016/0017/0018/0022 and TurnPlan schema 1 | Strict admission/report states, factual requirements, four-action ordered completion, pause/drift/rejection/error/unknown outcome, neutral event order, event-sink failure independence, and watcher-protocol adaptation | No | Ordered core, bounded events, and watcher adapter implemented offline; CLI loading and explicit recovery pending; independent of knowledge/M5 |
