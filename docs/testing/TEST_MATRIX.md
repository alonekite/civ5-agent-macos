...
| Binary quantity-bearing knowledge | Real merged database imported twice with 344 attributed references across 48 table families and equal hashes | Synthetic coverage of every configured table plus negative, invalid-integer, duplicate-reference, and fake-feature cases | N/A | Implemented offline |
