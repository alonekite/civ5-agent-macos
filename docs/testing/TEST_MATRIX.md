...
| Binary quantity-bearing knowledge | Real merged database imported twice with 354 attributed references across 51 single-value table families plus project thresholds and equal hashes | Synthetic coverage of every configured table plus negative, invalid-integer, duplicate-reference, threshold, and fake-feature cases | N/A | Implemented offline |
| Single-context yield effects | Real merged database imported twice with 159 contextual references across 19 table families and equal hashes | Synthetic coverage of every configured table, same-edge/different-context identity, and invalid-integer cases | N/A | Implemented offline |
