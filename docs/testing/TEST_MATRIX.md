...
| M6 deterministic turn executor | ADR-0015/0016/0017/0018/0022 and TurnPlan schema 1 | Plan/action/report models, canonical state digest, strict admission/report states, stable factual requirement ordering, ordinary/special research separation, inactive-turn short circuit, and legacy-controller compatibility | No | Admission and requirement layers implemented offline; ordered execution/recovery pending; independent of knowledge/M5 |
