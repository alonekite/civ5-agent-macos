...
| Session/match identity and turn journal | ADR-0017/0019 and proposed contracts | No implementation yet | N/A | Must reject unbound sessions; no permanent save ID is claimed; M2 audit remains independent |
