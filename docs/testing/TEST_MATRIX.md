...
| M6 deterministic turn executor | ADR-0015/0016/0017/0018/0022 and TurnPlan schema 1 | Strict admission/report states, factual requirements, four-action ordered completion, pause/drift/rejection/error/unknown outcome, neutral event order, and event-sink failure independence | No | Ordered core and bounded events implemented offline; watcher adapter and explicit recovery pending; independent of knowledge/M5 |
