...
| Binary quantity-bearing knowledge | Real merged database imported twice with 419 attributed binary references across 58 single-value families, four multi-attribute promotion families, and project thresholds with equal hashes | Synthetic coverage of every configured table plus negative, invalid-integer/boolean, duplicate-reference, threshold, and fake-feature cases | N/A | Implemented offline |
| Single-context effects | Real merged database imported twice with 197 contextual references, including technology-conditioned promotion passability, and equal hashes | Synthetic coverage of every configured table, same-edge/different-context identity, plain and attributed context, and invalid-integer cases | N/A | Implemented offline |
