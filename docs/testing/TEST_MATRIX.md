...
| M6 deterministic turn executor | ADR-0015/0016/0017/0018/0022 and TurnPlan schema 1 | Plan/action/report models, canonical state digest, strict UUID/session/turn/player/basis/argument/bound/order validation, and mutually exclusive report-state tests | No | Admission layer implemented offline; ordered execution/recovery pending; independent of knowledge/M5 |
