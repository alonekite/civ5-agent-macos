...
| R-010 | A future journal grows without bounds or mixes different matches or bridge sessions | Medium | Medium | Planned | Separate match/session identities under ADR-0017; require explicit bindings, bounded records, retention/export policy, sequence and integrity checks in M5 |
