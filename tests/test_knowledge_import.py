...
class TechnologyImportTest(unittest.TestCase):
    def test_imports_allowlisted_facts_and_relationships(self):
        ...
        self.assertEqual(pottery.attributes["era"], "ERA_ANCIENT")
        self.assertNotIn("ai_weight", pottery.attributes)
        self.assertEqual(bundle.references[0].kind, "requires_all")
        self.assertEqual(bundle.references[0].target_type_id, "TECH_AGRICULTURE")
